#ifndef _PLANE_INTERACTOR_H_
#define _PLANE_INTERACTOR_H_
...
class PlaneInteractor : public AbstractInteractor {
public :
  AR_CLASS(PlaneInteractor)
  AR_CONSTRUCTOR_3(PlaneInteractor, ArRef<BodyController>, bodyController, ArRef<JointController>, jointController, ArRef<AnchorController>, anchorController)
